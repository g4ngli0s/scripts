...
alphanumenc_save.py
Version mejorada para ahorrar bytes del encoder hecho por greyshell
...
bsidessf17_dnscap_script3.pl
Script de volcado de datos de paquetes y borrado de primeros 9 bytes de cada paquete en el reto dnscap del CTF bsidessf 2017 (forensics).
...
xorregchars.py
Halla entre los posibles valores de caracters válidos la combinación de ellos que la operación AND es 0
```
